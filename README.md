...
```
  ...
  Go structs as example wich is JSON encoded and the passed to the client. Corresponding datastructures is needed on the client side to encode the reponse:
  ```
